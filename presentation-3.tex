...
\subsection{Problems from the past}
\begin{frame}{Most troublesome issues}
...
\begin{itemize}
\item Base cap size of 8pF, to prevent output voltage drooping
\item nmos2v's used in certain spots to prevent leakage
\item Charge pump implemented to further stop leakage across op-amp during amplify phase
\end{itemize}
\end{block}
\end{frame}
...
\item Total cost comes out to 1.64 cents
\end{itemize}
\end{center}
\end{frame}
%
