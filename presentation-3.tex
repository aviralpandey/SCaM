...
\begin{itemize}
\item Base cap size of 8pF, to prevent leakage
\item Extra Switch required for convergence 
\end{itemize}
\end{block}
...
\begin{itemize}
\item Added another switch in phase 1 to fix convergence issues
\item C = 8pF to prevent leakage from affecting voltage
\end{itemize}
\end{block}
\begin{center}
